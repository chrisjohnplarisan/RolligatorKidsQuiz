...
public class ImagePlayQuizFragment extends Fragment {
    ...
    public static ImagePlayQuizFragment newInstance(Bundle bundle) {
        ImagePlayQuizFragment fragment = new ImagePlayQuizFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_img_play_quiz, container, false);
    }
