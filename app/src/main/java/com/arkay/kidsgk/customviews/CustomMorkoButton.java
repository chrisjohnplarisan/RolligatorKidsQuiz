...
public class CustomMorkoButton extends Button {
    public CustomMorkoButton(Context context) {
        super(context);
        init(null);

    }

    public CustomMorkoButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);

    }

    public CustomMorkoButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public CustomMorkoButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
